...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	pulseService := service.NewPulseService(configConfig, accountRepository, accountUsageService)
