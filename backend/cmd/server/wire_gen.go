...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	usageRequestCaptureRepository := repository.NewUsageRequestCaptureRepository(client, db)
	usageCaptureService := service.NewUsageCaptureService(usageRequestCaptureRepository, configConfig)
	gatewayService := service.NewGatewayService(accountRepository, groupRepository, usageLogRepository, usageBillingRepository, userRepository, userSubscriptionRepository, userGroupRateRepository, gatewayCache, configConfig, schedulerSnapshotService, concurrencyService, billingService, rateLimitService, billingCacheService, identityService, httpUpstream, deferredService, claudeTokenProvider, sessionLimitCache, rpmCache, digestSessionStore, settingService, tlsFingerprintProfileService, channelService, modelPricingResolver, balanceNotifyService, serviceUserPlatformQuotaRepository, usageCaptureService)
	...
	usageRequestCaptureShareRepository := repository.NewUsageRequestCaptureShareRepository(client, db)
	usageCaptureShareService := service.NewUsageCaptureShareService(usageRequestCaptureShareRepository, usageCaptureService)
	adminUsageHandler := admin.NewUsageHandler(usageService, apiKeyService, adminService, usageCleanupService, usageCaptureService, usageCaptureShareService, configConfig)
	...
	weeklyQuotaLedger := repository.NewWeeklyQuotaLedger(redisClient)
	weeklyQuotaService := service.NewWeeklyQuotaService(configConfig, weeklyQuotaLedger, usageLogRepository, accountUsageService)
	gatewayHandler := handler.NewGatewayHandler(gatewayService, geminiMessagesCompatService, antigravityGatewayService, userService, concurrencyService, billingCacheService, usageService, apiKeyService, usageRecordWorkerPool, errorPassthroughService, contentModerationService, userMessageQueueService, configConfig, settingService, usageCaptureService, weeklyQuotaService)
	...
	pulseService := service.NewPulseService(configConfig, accountUsageService, weeklyQuotaService)
	pulseHandler := handler.NewPulseHandler(configConfig, pulseService)
	usageCaptureViewHandler := handler.NewUsageCaptureViewHandler(configConfig, usageCaptureService)
	usageCaptureShareViewHandler := handler.NewUsageCaptureShareViewHandler(usageCaptureShareService)
	idempotencyCoordinator := service.ProvideIdempotencyCoordinator(idempotencyRepository, configConfig)
	idempotencyCleanupService := service.ProvideIdempotencyCleanupService(idempotencyRepository, configConfig)
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, channelMonitorUserHandler, adminHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler, handlerPaymentHandler, paymentWebhookHandler, availableChannelHandler, pulseHandler, usageCaptureViewHandler, usageCaptureShareViewHandler, idempotencyCoordinator, idempotencyCleanupService)
	...
	usageCaptureRetentionService := service.ProvideUsageCaptureRetentionService(usageRequestCaptureRepository, configConfig)
	scheduledTestRunnerService := service.ProvideScheduledTestRunnerService(scheduledTestPlanRepository, scheduledTestService, accountTestService, rateLimitService, configConfig)
	paymentOrderExpiryService := service.ProvidePaymentOrderExpiryService(paymentService, leaderLockCache, db)
	channelMonitorRunner := service.ProvideChannelMonitorRunner(channelMonitorService, settingService)
	userPlatformQuotaUsageFlusher := service.ProvideUserPlatformQuotaUsageFlusher(configConfig, billingCache, serviceUserPlatformQuotaRepository, timingWheelService)
	v := provideCleanup(client, redisClient, opsMetricsCollector, opsAggregationService, opsAlertEvaluatorService, opsCleanupService, opsScheduledReportService, opsSystemLogSink, schedulerSnapshotService, tokenRefreshService, accountExpiryService, proxyExpiryService, subscriptionExpiryService, usageCleanupService, usageCaptureRetentionService, idempotencyCleanupService, pricingService, emailQueueService, billingCacheService, usageRecordWorkerPool, subscriptionService, oAuthService, openAIOAuthService, geminiOAuthService, antigravityOAuthService, grokOAuthService, openAIGatewayService, scheduledTestRunnerService, backupService, paymentOrderExpiryService, channelMonitorRunner, userPlatformQuotaUsageFlusher)
