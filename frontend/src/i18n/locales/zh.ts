export default {
  ...
  usage: {
    ...
    share: {
      ...
      expiryCustom: '自定义',
      customDays: '天数',
      customDaysPlaceholder: '请输入天数',
      labelOptional: '标签（可选）',
      labelPlaceholder: '可选备注，例如分享给谁',
      create: '创建链接',
      creating: '创建中...',
      close: '关闭',
      publicUrl: '公开链接',
      publicUrlHint: '任何人凭此链接均可查看该会话，无需登录。',
      copy: '复制',
      copySuccess: '链接已复制到剪贴板',
      createSuccess: '分享链接已创建',
      createFailed: '创建分享链接失败',
      captureNotFound: '捕获记录不可用或已过期，无法创建分享',
      columnLink: '链接',
      columnStatus: '状态',
      columnLabel: '标签',
      columnCreated: '创建时间',
      ...
      revokeConfirmMessage: '撤销此分享链接？持有该链接的人将立即失去访问权限。',
