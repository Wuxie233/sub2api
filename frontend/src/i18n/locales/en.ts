export default {
  ...
  usage: {
    ...
    share: {
      button: 'Share',
      manageButton: 'Manage shares',
      createTitle: 'Create share link',
      manageTitle: 'Manage shares',
      expiry: 'Expiry',
      ...
      labelPlaceholder: 'Optional note, e.g. who you shared with',
      create: 'Create link',
      creating: 'Creating...',
      close: 'Close',
      publicUrl: 'Public link',
      publicUrlHint: 'Anyone with this link can view this conversation. No login required.',
      copy: 'Copy',
      copySuccess: 'Link copied to clipboard',
      createSuccess: 'Share link created',
      createFailed: 'Failed to create share link',
      captureNotFound: 'Capture record is unavailable or has expired; cannot create a share',
      columnLink: 'Link',
      columnStatus: 'Status',
      columnLabel: 'Label',
      ...
      revokeConfirmMessage: 'Revoke this share link? Anyone holding the link will lose access immediately.',
